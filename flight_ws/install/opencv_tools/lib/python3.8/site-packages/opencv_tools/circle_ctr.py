...
class CircleCtr(Node):
    ...
    def __init__(self):
        ...
        """
        super().__init__('circle_ctr')
        
        # Create the subscriber to receive an Image from the video_frames topic
        ...
        #self.publisher_ = self.create_publisher(UInt8, 'circle_position', 10)
