...
class LeftQRCodeReader(Node):
    def __init__(self):
        super().__init__('left_qr_code_reader')
        ...
        self.publisher_content = self.create_publisher(String, 'left_qr_code_content', 10)
        self.publisher_position = self.create_publisher(Point, 'left_qr_code_position', 10)
