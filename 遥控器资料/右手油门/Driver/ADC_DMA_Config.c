...
void ADC1_Mode_Config(void)
{
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 3, ADC_SampleTime_55Cycles5);			//1横滚遥杆->偏航遥杆3
	ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 4, ADC_SampleTime_55Cycles5);			//2俯仰遥杆->油门遥杆4
	ADC_RegularChannelConfig(ADC1, ADC_Channel_7, 2, ADC_SampleTime_55Cycles5);			//3偏航遥杆->横滚遥杆1
	ADC_RegularChannelConfig(ADC1, ADC_Channel_8, 1, ADC_SampleTime_55Cycles5);			//4油门遥杆->俯仰遥杆2
