...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01操作线   
#define Set_NRF24L01_CSN    (GPIOB->BSRR = GPIO_Pin_12)		// PA4
#define Clr_NRF24L01_CSN    (GPIOB->BRR = GPIO_Pin_12)		// PA4
#define Set_NRF24L01_CE 	(GPIOB->BSRR = GPIO_Pin_10)		// PB10
#define Clr_NRF24L01_CE  	(GPIOB->BRR = GPIO_Pin_10)		// PB10
#define READ_NRF24L01_IRQ   (GPIOA->IDR&GPIO_Pin_3)			//IRQ主机数据输入 PA3
...
//	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;          //NRF24L01 模块片选信号
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;    //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_Init(GPIOB, &GPIO_InitStructure);
